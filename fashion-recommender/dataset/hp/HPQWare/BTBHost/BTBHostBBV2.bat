...
if "%R_ENTRDY%" == "1" (
	...
	if "%IsWin11%" == "1" (
		...
		if "%languagecode%" == "ACB" (
			...
			echo xcopy /e/i/y/f "%~dp0MMD" "C:\Users\Default\AppData\Local\Microsoft\Windows\Shell" >> %logs%\%~nx0.log
			xcopy /e/i/y/f "%~dp0MMD" "C:\Users\Default\AppData\Local\Microsoft\Windows\Shell" >> %logs%\%~nx0.log 2>&1
		)
